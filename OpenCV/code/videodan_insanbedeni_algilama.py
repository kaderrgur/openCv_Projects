...
vid = cv2.VideoCapture('C:\\Users\\Kader\\Desktop\\OpenCV\\test_videos\\body.mp4')

# 3. Kullanacağımız cascade dosyalarını çalışmamıza dahil edelim.
body_cascade = cv2.CascadeClassifier("C:\\Users\\Kader\\Desktop\\OpenCV\\haarCascade\\fullbody.xml")
